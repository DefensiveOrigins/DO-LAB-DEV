...
mkdir c:\doaz\gpo
cd c:\doaz\gpo
Invoke-WebRequest -URI https://github.com/DefensiveOrigins/DO-LAB-DEV/raw/test/Deploy-AD/resources/doazlab_gpos.zip -Outfile doazlab_gpos.zip
...
cd c:\doaz\gpo
Invoke-WebRequest -URI https://github.com/DefensiveOrigins/DO-LAB-DEV/raw/test/Deploy-AD/resources/layout.xml -Outfile layout.xml
